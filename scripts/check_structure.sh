...
files=(
  ...
  "scripts/tests/test_claude_legacy_cleanup_deploy.sh"
  ...
  "scripts/tests/test_cleanup_legacy_claude_content.py"
...
bash "$repo_root/scripts/tests/test_claude_legacy_cleanup_deploy.sh"
...
uv run python -m py_compile "$repo_root/scripts/cleanup_legacy_claude_content.py"
