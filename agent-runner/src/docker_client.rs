...
impl ContainerSpec {
    pub fn from_settings(settings: &Settings) -> Self {
        Self {
            ...
            bifrost_port: settings.bifrost_port,
            bifrost_provider_name: settings.bifrost_provider_name.clone(),
            bifrost_model: settings.bifrost_model.clone(),
            bifrost_upstream_base_url: settings.bifrost_upstream_base_url.clone(),
            bifrost_upstream_api_key: settings.bifrost_upstream_api_key.clone(),
            bifrost_upstream_provider_type: settings.bifrost_upstream_provider_type.clone(),
    ...
    pub fn create_config(&self) -> Config<String> {
        ...
        let env = vec![
            ...
            format!("ANTHROPIC_DEFAULT_SONNET_MODEL={}", self.bifrost_model),
            format!("ANTHROPIC_DEFAULT_HAIKU_MODEL={}", self.bifrost_model),
            format!("ANTHROPIC_DEFAULT_OPUS_MODEL={}", self.bifrost_model),
            ...
            format!("BIFROST_PORT={}", self.bifrost_port),
            format!("BIFROST_PROVIDER_NAME={}", self.bifrost_provider_name),
            format!("BIFROST_MODEL={}", self.bifrost_model),
            format!(
